<?php
/**
 * The template part for showing events single post in Your theme
 *
 * To show events single post in your theme, you can use from this template part.
 * Note: in this starter theme, we imagine that we already activated event custom post type
...
<div class="msn-container">
    ...
    <div class="msn-page-banner">
        ...
        <div class="msn-page-banner intro">
            <h2>This template file uses to show event custom post type</h2>
        </div>
    </div>
    ...
    <div class="msn-metabox">
        ...
        <p>
            <a class="msn-link" href="<?php echo site_url( '/events/' ); ?>">
                Back to events
            </a>
